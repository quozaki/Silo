          ...
          <div className="mockup-body">
            <div className="m-sidebar">
              ...
              <div className="sb-env">
                <div className="e-dot e-dot-blue"></div>
                <span className="e-name">Main account</span>
                <span className="e-badge live">Live</span>
              </div>
              <div className="sb-env">
                <div className="e-dot e-dot-green"></div>
                <span className="e-name">Alt account</span>
                <span className="e-badge live">Live</span>
              </div>
              <div className="sb-env">
                <div className="e-dot e-dot-gray"></div>
                <span className="e-name">Account 3</span>
            ...
            <div className="m-main">
              <div className="m-tabbar">
                <div className="m-tab active">
                  <div className="t-dot t-dot-blue"></div>
                  Main account
                </div>
